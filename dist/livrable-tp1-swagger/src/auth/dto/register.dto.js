...
class RegisterDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String, format: "email" }, password: { required: true, type: () => String, minLength: 8 }, role: { required: false, type: () => Object, enum: ['customer', 'owner', 'admin'] } };
    }
}
